...
startTimer.addEventListener("click", function () {
    ...
    timer2 = setInterval(secoundSlot, 100);
    timer3 = setInterval(thirdSlot, 100);
    timer4 = setInterval(forthSlot, 150);
    timer5 = setInterval(fiveSlot, 150);
    timer6 = setInterval(sixSlot, 150);
    timer7 = setInterval(sevenSlot, 130);
    timer8 = setInterval(eightSlot, 130);
    timer9 = setInterval(nineSlot, 130);
